...
global.owner = ['6285807174320','628819547416']
global.mods = ['6285807174320','628819547416']// Want some help?
  ...
  try {
    ...
    try {
      ...
      if (user = global.DATABASE._data.users[m.sender]) {
        ...
        if (!isNumber(user.lastclaim)) user.lastclaim = 20
    ...
    m.exp += 1
      ...
      let _prefix = plugin.customPrefix ? plugin.customPrefix : conn.prefix ? conn.prefix : global.prefix
        ...
        if (xp > 999999) m.reply('Ngecit -_-') // Hehehe
        else m.exp += xp
...
conn.welcome = 'Hai beban keluarga🥳, @user!\n Welcome to grub semoga betah ya🤗🥰@subject'
conn.bye = 'Semoga tenang disana ya semoga masuk surga ya🤗@user!'
